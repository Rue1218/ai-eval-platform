...
<style scoped>.tool-run{border:1px solid var(--border,#dfe7e3);border-radius:10px;background:var(--bg-card,#fff);margin:10px 0;font-family:Inter,"Segoe UI Variable Text","Microsoft YaHei UI",sans-serif}.tool-run>summary{display:flex;align-items:center;gap:10px;padding:12px;cursor:pointer;list-style:none}.tool-run>summary:after{content:'⌄';color:#7b8b83}.tool-title{flex:1;min-width:0;font-size:13px;font-weight:620}.tool-title small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#607489}.tool-state{font-size:11px;color:#28745d}.failed .tool-state,.outcome_unknown .tool-state{color:#b45309}.tool-body{padding:0 16px 14px}.tool-body h4{font-size:12px;color:#475569;margin:10px 0 5px}.tool-body pre{white-space:pre-wrap;overflow-wrap:anywhere;max-height:380px;overflow:auto;border:1px solid #dce5f0;background:linear-gradient(135deg,#f8fbff,#f3f7fd);padding:10px;border-radius:6px;color:#0f3d65;font:12px/1.65 ui-monospace,SFMono-Regular,Consolas,"Microsoft YaHei UI",monospace;font-variant-numeric:tabular-nums}.tool-body section:first-child pre{color:#7c2d12;background:linear-gradient(135deg,#fffaf5,#fff6eb)}.tool-body p{font-size:12px;color:#80644c}</style>
