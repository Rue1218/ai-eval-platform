...
<style scoped>.tool-run{border:1px solid var(--border,#dfe7e3);border-radius:10px;background:var(--bg-card,#fff);margin:10px 0}.tool-run>summary{display:flex;align-items:center;gap:10px;padding:12px;cursor:pointer;list-style:none}.tool-run>summary:after{content:'⌄';color:#7b8b83}.tool-title{flex:1;min-width:0;font-size:13px}.tool-title small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#728179}.tool-state{font-size:11px;color:#597468}.failed .tool-state,.outcome_unknown .tool-state{color:#ac582b}.tool-body{padding:0 16px 14px}.tool-body h4{font-size:12px;color:#64748b;margin:10px 0 5px}.tool-body pre{white-space:pre-wrap;overflow-wrap:anywhere;max-height:380px;overflow:auto;background:#f5f8f6;padding:10px;border-radius:6px;font-size:12px}.tool-body p{font-size:12px;color:#80644c}</style>
