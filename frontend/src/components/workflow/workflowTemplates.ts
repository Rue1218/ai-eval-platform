...
export const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  {
    ...
    edges: [
      { id: 'e1', sourceNodeId: 'node-bm-ds', sourcePortId: 'out', targetNodeId: 'node-bm-eval', targetPortId: 'in_ds' },
      { id: 'e2', sourceNodeId: 'node-bm-eval', sourcePortId: 'out', targetNodeId: 'node-bm-judge', targetPortId: 'in' },
      { id: 'e3', sourceNodeId: 'node-bm-judge', sourcePortId: 'out', targetNodeId: 'node-bm-gate', targetPortId: 'in' },
      { id: 'e4', sourceNodeId: 'node-bm-gate', sourcePortId: 'pass', targetNodeId: 'node-bm-stress', targetPortId: 'in_gate' },
      { id: 'e5', sourceNodeId: 'node-bm-stress', sourcePortId: 'out', targetNodeId: 'node-bm-rep', targetPortId: 'in' },
    ],
  },
  {
    ...
    edges: [
      { id: 're1', sourceNodeId: 'node-rag-eval', sourcePortId: 'out', targetNodeId: 'node-rag-judge', targetPortId: 'in' },
      { id: 're2', sourceNodeId: 'node-rag-judge', sourcePortId: 'out', targetNodeId: 'node-rag-gate', targetPortId: 'in' },
      { id: 're3', sourceNodeId: 'node-rag-gate', sourcePortId: 'pass', targetNodeId: 'node-rag-stress', targetPortId: 'in_gate' },
      { id: 're4', sourceNodeId: 'node-rag-stress', sourcePortId: 'out', targetNodeId: 'node-rag-rep', targetPortId: 'in' },
    ],
  },
  {
    ...
    edges: [
      { id: 'ce1', sourceNodeId: 'node-case-gen', sourcePortId: 'out', targetNodeId: 'node-case-gate', targetPortId: 'in' },
      { id: 'ce2', sourceNodeId: 'node-case-gate', sourcePortId: 'pass', targetNodeId: 'node-case-ds', targetPortId: 'out' },
      { id: 'ce3', sourceNodeId: 'node-case-ds', sourcePortId: 'out', targetNodeId: 'node-case-bm', targetPortId: 'in_ds' },
      { id: 'ce4', sourceNodeId: 'node-case-bm', sourcePortId: 'out', targetNodeId: 'node-case-rep', targetPortId: 'in' },
    ],
  },
  {
    ...
    edges: [
      { id: 'ae1', sourceNodeId: 'node-kernel', sourcePortId: 'out_bm', targetNodeId: 'node-w-gpu', targetPortId: 'in' },
      { id: 'ae2', sourceNodeId: 'node-kernel', sourcePortId: 'out_rag', targetNodeId: 'node-w-vec', targetPortId: 'in' },
      { id: 'ae3', sourceNodeId: 'node-kernel', sourcePortId: 'out_stress', targetNodeId: 'node-w-stress', targetPortId: 'in' },
      { id: 'ae4', sourceNodeId: 'node-w-gpu', sourcePortId: 'out', targetNodeId: 'node-w-bm', targetPortId: 'in_sig' },
      { id: 'ae5', sourceNodeId: 'node-w-vec', sourcePortId: 'out', targetNodeId: 'node-w-rag', targetPortId: 'in_sig' },
      { id: 'ae6', sourceNodeId: 'node-w-stress', sourcePortId: 'out', targetNodeId: 'node-w-st', targetPortId: 'in_sig' },
      { id: 'ae7', sourceNodeId: 'node-w-bm', sourcePortId: 'out', targetNodeId: 'node-w-rep', targetPortId: 'in' },
      { id: 'ae8', sourceNodeId: 'node-w-rag', sourcePortId: 'out', targetNodeId: 'node-w-rep', targetPortId: 'in' },
      { id: 'ae9', sourceNodeId: 'node-w-st', sourcePortId: 'out', targetNodeId: 'node-w-rep', targetPortId: 'in' },
    ],
  },
]
