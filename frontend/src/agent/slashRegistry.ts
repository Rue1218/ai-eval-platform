 ...
 * /help /stop /compact 已开放；/cancel /stress 未开放（禁用态 + reason）。
 */
...
export const SYSTEM_SLASH_COMMANDS: SlashCommandDef[] = [
  ...
  { name: 'cancel', hint: '取消任务', group: 'control', enabled: false, reason: '后续版本开放' },
  { name: 'stress', hint: '压测任务', group: 'order', enabled: false, reason: '后续版本开放' },
]
