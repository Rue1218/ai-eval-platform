...
def _probe_efforts(probe: object) -> tuple[str, ...] | None:
    ...
    if not isinstance(values, list):
        return ()
    return tuple(effort for effort in values if effort in EFFORTS)
...
def profile_reasoning(
    ...
    *,
    ...
    if reasoning_template_id:
        ...
        candidates = _probe_efforts(reasoning_probe) or ()
    else:
        candidates = EFFORTS
