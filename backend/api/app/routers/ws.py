...
from ..models import Message, Setting, User, WsEvent
...
# 待处理卡持久化层（ws_cards）：同名 re-export，保持既有调用点与测试引用不变
from .ws_cards import (
    _CONFIRM_SCHEMA_VERSION as _CONFIRM_SCHEMA_VERSION,
)
from .ws_cards import (
    _approval_overdue as _approval_overdue,
)
from .ws_cards import (
    _card_age_seconds as _card_age_seconds,
)
from .ws_cards import (
    _card_meta as _card_meta,
)
from .ws_cards import (
    _clear_pending_confirm as _clear_pending_confirm,
)
from .ws_cards import (
    _confirm_author_payload as _confirm_author_payload,
)
from .ws_cards import (
    _error_code_from_payload as _error_code_from_payload,
)
from .ws_cards import (
    _persist_pending_approval as _persist_pending_approval,
)
from .ws_cards import (
    _persist_pending_clarify as _persist_pending_clarify,
)
from .ws_cards import (
    _persist_pending_confirm as _persist_pending_confirm,
)
from .ws_cards import (
    _restore_pending_confirm as _restore_pending_confirm,
)
from .ws_emit import (
    _EVENT_VERSION_KEY as _EVENT_VERSION_KEY,
)

# 事件发射层（ws_emit）：同名 re-export，保持既有调用点与测试 patch 目标不变
from .ws_emit import (
    _ConnectionState as _ConnectionState,
)
from .ws_emit import (
    _emit_error as _emit_error,
)
from .ws_emit import (
    _emit_persistent as _emit_persistent,
)
from .ws_emit import (
    _event_vocab_mismatch as _event_vocab_mismatch,
)
from .ws_emit import (
    _frame as _frame,
)
from .ws_emit import (
    _next_event_id as _next_event_id,
)
from .ws_emit import (
    _send as _send,
)
from .ws_emit import (
    _send_unlocked as _send_unlocked,
)
from .ws_emit import (
...
from .ws_profiles import (
    _infer_provider as _infer_provider,
)

# 协议档配置解析层（ws_profiles）：同名 re-export；缓存容器只在新模块内读写
from .ws_profiles import (
    _ProfileSnapshot as _ProfileSnapshot,
)
from .ws_profiles import (
    _selected_model_config as _selected_model_config,
)
