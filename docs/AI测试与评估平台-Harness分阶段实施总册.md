...
| 4 | [阶段4-记忆层接入](docs/AI测试与评估平台-Harness阶段4-记忆层接入.md) V1.5 | `fix/memory-activation` | MemoryPort + Redis/pgvector；不接 LightRAG | 阶段 4.1 已修复首批 4 个 P1、1 个 P2 并接入 PG 对话归档；pgvector/容器联调未完成，**阶段 4 未验收** |
